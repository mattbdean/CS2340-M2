 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Julianne Lefelhocz");
		  toPrint += p1.toString("jefelhocz3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Matthew Dean");
		  toPrint += p2.toString("mdean42");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Govinda Harris");
		  toPrint += p3.toString("gharris45");
